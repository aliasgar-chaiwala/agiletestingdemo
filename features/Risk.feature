...
@regression
  Scenario: Createing Risk
    ...
    When I create new Remains Risk
    Then I should see the created Risk Title	
    When I update the created Risk
    Then I should see the updated Risk Title
  ...
  Scenario: As a user able to verify all available fields for risk
    ...
    Then I should not see "Default Link" Event on facet
    And I navigate to Needs Risks and Strengths widget
    Then I verify the Risk Available Fields
